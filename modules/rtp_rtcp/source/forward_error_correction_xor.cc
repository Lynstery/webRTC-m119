...
XorForwardErrorCorrection::XorForwardErrorCorrection(
...
XorForwardErrorCorrection::~XorForwardErrorCorrection() = default;

int XorForwardErrorCorrection::EncodeFec(const PacketList& media_packets,
...
int XorForwardErrorCorrection::NumFecPackets(int num_media_packets,
...
void XorForwardErrorCorrection::GenerateFecPayloads(
...
int XorForwardErrorCorrection::InsertZerosInPacketMasks(
    const PacketList& media_packets,
    size_t num_fec_packets) {
...
void XorForwardErrorCorrection::FinalizeFecHeaders(size_t num_fec_packets,
                                                uint32_t media_ssrc,
...
void XorForwardErrorCorrection::ResetState(
...
void XorForwardErrorCorrection::InsertMediaPacket(
    RecoveredPacketList* recovered_packets,
...
void XorForwardErrorCorrection::UpdateCoveringFecPackets(
...
void XorForwardErrorCorrection::InsertFecPacket(
...
void XorForwardErrorCorrection::AssignRecoveredPackets(
    const RecoveredPacketList& recovered_packets,
...
void XorForwardErrorCorrection::InsertPacket(
    const ReceivedPacket& received_packet,
    RecoveredPacketList* recovered_packets) {
...
bool XorForwardErrorCorrection::StartPacketRecovery(
...
bool XorForwardErrorCorrection::FinishPacketRecovery(
    const ReceivedFecPacket& fec_packet,
    RecoveredPacket* recovered_packet) {
...
void XorForwardErrorCorrection::XorHeaders(const Packet& src, Packet* dst) {
...
void XorForwardErrorCorrection::XorPayloads(const Packet& src,
...
bool XorForwardErrorCorrection::RecoverPacket(const ReceivedFecPacket& fec_packet,
                                           RecoveredPacket* recovered_packet) {
...
size_t XorForwardErrorCorrection::AttemptRecovery(
    RecoveredPacketList* recovered_packets) {
...
int XorForwardErrorCorrection::NumCoveredPacketsMissing(
    const ReceivedFecPacket& fec_packet) {
...
void XorForwardErrorCorrection::DiscardOldRecoveredPackets(
    RecoveredPacketList* recovered_packets) {
...
bool XorForwardErrorCorrection::IsOldFecPacket(
    const ReceivedFecPacket& fec_packet,
    const RecoveredPacketList* recovered_packets) {
...
ForwardErrorCorrection::DecodeFecResult XorForwardErrorCorrection::DecodeFec(
    const ReceivedPacket& received_packet,
    RecoveredPacketList* recovered_packets) {
