...
if [ "$#" -lt 7 ] || [ "$#" -gt 8 ]; then
  echo "Usage: $0 VIDEO_NAME WIDTH HEIGHT FPS END_INDEX ENCODE_BITRATE RESULT_NAME [EXTRA]"
  echo "Example:"
  echo "  $0 game2 1280 720 30 3000 10 result1 Exp-RefMod/Dynamic/Exp-FixedReferenceStep/10/"
  exit 1
fi
